# This file corresponds to the credit approval analysis
...
source("R/constraints_r1_r2.R") # constraint matrix
...
# doc: http://archive.ics.uci.edu/ml/datasets/Statlog+%28German+Credit+Data%29
# (accessed: 07.02.2023)
credit_appl_data <- read_csv("data/credit.data")
...
### Step 3: Compute the permutation test based on four different epsilon values
...
# saveRDS(d_observed_reverse, file = "d_observed_reverse_credit.rds")
